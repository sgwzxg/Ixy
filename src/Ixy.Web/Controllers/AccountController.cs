...
using Ixy.Web.ViewModels.AccountViewModels;
...
namespace Ixy.Web.Controllers
{
    ...
    public class AccountController : IxyController
    {
        ...
        public AccountController(
            ...
            SignInManager<IxyUser> signInManager,
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new IxyUser { UserName = model.Email, Email = model.Email };
        ...
        private Task<IxyUser> GetCurrentUserAsync()
        {
